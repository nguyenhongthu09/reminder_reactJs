...
class EditListForm extends Component {
   ...
   componentDidUpdate(prevProps) {
    if (this.props.listId !== prevProps.listId) {
      ...
      this.setState({
        selectedColor: selectedList.isColor,
        form: {
    ...
    render(){
        return (
            ...
            <div className="form_add_list_name">
              ...
              <input type="text" id="name_edit-list" placeholder="Tên Danh Sách" name='name'   value={this.state.form.name}
            ...
            >
              <RenderColorOnUi></RenderColorOnUi>
            </div>
          </form>       
        )
    }
